...
export const questionRevisions = sqliteTable("question_revisions", {
  ...
  tableData: text("table_data").notNull().default(""),
  imageUrls: text("image_urls").notNull().default("[]"),
  contentBlocks: text("content_blocks").notNull().default("[]"),
  alternativeBlocks: text("alternative_blocks").notNull().default("[]"),
  authenticatedAt: text("authenticated_at").notNull().default(""),
  authenticatedBy: text("authenticated_by").notNull().default(""),
  isLocked: integer("is_locked", { mode: "boolean" }).notNull().default(false),
  lockedAt: text("locked_at").notNull().default(""),
  lockedBy: text("locked_by").notNull().default(""),
  lastUnlockReason: text("last_unlock_reason").notNull().default(""),
